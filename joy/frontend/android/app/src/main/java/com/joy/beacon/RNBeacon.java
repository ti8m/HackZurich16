...
public class RNBeacon extends ReactContextBaseJavaModule {
    ...
    private void connectToBeaconService(Region beaconRegion) {

        final Region region = beaconRegion;

        Log.v(BEACON, "inside connectToBeaconService");
        beaconManager.connect(new BeaconManager.ServiceReadyCallback() {
            @Override
            public void onServiceReady() {
                Log.v(BEACON, "service is ready");
                isConnected = true;
                Log.v(BEACON, "isConnected: " + isConnected);
